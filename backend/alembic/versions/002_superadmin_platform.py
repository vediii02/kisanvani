...
def upgrade():
    ...
    op.create_table('platform_config',
        ...
        sa.Column('rag_enabled', sa.Boolean(), nullable=False, server_default='1'),
        sa.Column('rag_top_k', sa.Integer(), nullable=False, server_default='5'),
        sa.Column('enable_product_safety_check', sa.Boolean(), nullable=False, server_default='1'),
        sa.Column('auto_escalate_low_confidence', sa.Boolean(), nullable=False, server_default='1'),
